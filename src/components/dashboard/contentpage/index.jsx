          ...
          <div className="bg-[#262d34] p-[20px] lg:p-[30px] mt-6 rounded-[16px] gap-4  mr-[24px] md:mr-0">
            ...
            <div className="lg:pl-[62px] mt-[10px] lg:mt-[30px] text-[16px] leading-7">
              <p className="text-white">
                ...
                doloremque consectetur, velit voluptatum non eum totam,
                similique eveniet! Ducimus quas cum pariatur atque quo. Lorem
                ipsum dolor sit, amet consectetur adipisicing elit. Sequi
                facilis provident consequatur pariatur beatae, repellendus
                doloremque consectetur, velit voluptatum non eum totam,
                similique eveniet! Ducimus quas cum pariatur atque quo.
              </p>
              ...
              <p className="text-white mt-[18px] lg:mt-6">
                ...
                eius in fugit molestias vero natus error deleniti, quas qui
                neque quod, quibusdam est soluta laudantium provident assumenda
